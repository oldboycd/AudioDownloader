...
var audio;
var file;
var icon = document.getElementsByClassName('btn-audio icon icon-audio-play')[0]; //'blob:https%3A//web.whatsapp.com/3fb66b51-facf-43db-b5f5-1d5078705f40';
var style = icon.currentStyle || window.getComputedStyle(icon, false);
var img = style.backgroundImage.slice(4, -1);
